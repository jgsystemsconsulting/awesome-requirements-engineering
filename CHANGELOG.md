...
- README Install, Usage, Support, Licence, and Version sections aligned to the release standard.
- SECURITY.md switched to private advisory + PR reporting (no public email route).
