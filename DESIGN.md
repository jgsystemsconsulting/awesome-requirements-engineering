# DESIGN.md: Awesome Requirements Engineering

## Product

**Name:** Awesome Requirements Engineering  
**Purpose:** Public-domain curated index of requirements engineering standards, methods, interchange formats, tools, books, and community.  
**Primary users:** Requirements engineering practitioners.  
...
- Optional: simple monochrome RE-adjacent diagram only if it earns space; default is typography + list  
...
```text
Files read:
- awesome-archimate DESIGN.md / DESIGN_BRIEF.md / docs/index.html (family gold sample)
- styles/minimal-technical contract via that sample
- this repo README.md (sections, entry count, sweep badge)
```
